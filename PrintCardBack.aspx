<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintCardBack.aspx.cs" Inherits="PrintCardBack" %>
            ...
            <div id="divFinalDiv" runat="server" style="width: 40%; height:440px;margin: 0px auto;border:solid; page-break-after: always;background-color:lightblue">
                ...
                <div class="row" style="margin-top:50px">
                    <div class="col-md-12" style="text-align: left;">
                      <p style="margin: 0 0 25px 5px;">  
                          <asp:Label ID="Label9" runat="server" Style="font-weight: 700;font-size: small; font-family: Calibri;" Text="Address of Awardee/NoK :"></asp:Label>
                          <asp:Label ID="lbl_address" runat="server" Style="font-weight: 700; font-size: small; font-family: Calibri; margin-top: -5px"></asp:Label>
                         </p> 
                 ...
                 <div class="row">
                    <div class="col-md-12" style="text-align: left;">
                      <p style="margin: 0 0 25px 5px;">  <asp:Label ID="Label3" runat="server" Text="Mark of Identification of Awardee/NoK :" Style="font-weight: 700;font-size: small; font-family: Calibri;"></asp:Label>
                        <asp:Label ID="lblidentification" runat="server" Style="font-weight: 700; font-size: small; font-family: Calibri; margin-top: -5px"></asp:Label>
                         </p> 
                    </div>
                ...
                <div class="clearfix"></div>
                 ...
                 <div class="row">
                    <div class="col-md-12" style="text-align: left;">
                      <p style="margin: 0 0 25px 5px;">  
                          <asp:Label ID="Label16" runat="server" Style="font-weight: 700;font-size: small; font-family: Calibri;" Text="Mobile No: "></asp:Label>
                          <asp:Label ID="Label17" runat="server" Style="font-weight: 700; font-size: small; font-family: Calibri; margin-top: -5px" Text=" "></asp:Label>
                          <asp:Label ID="lbl_mobile" runat="server" Style="font-weight: 700; font-size: small; font-family: Calibri; margin-top: -5px"></asp:Label>
                         </p> 
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12" style="text-align: left;margin-left:20px;margin-right:20px; font-size:small">
