...
public partial class PrintCardFront : System.Web.UI.Page
{
    ...
    public void filldetails(string EID)
    {
        ...
        if (sdr.Read())
        {
            ...
            if (ispos=="No")
            //if (Session["is_posthumous"].ToString() == "Yes")
            {
                //lblKinName1.Visible = false;
                //lblName_of_awardee_kin1.Visible = false;
                //lblDOAKin0.Visible = false;
                //lbldobnok1.Visible = false;
                divnopos.Visible = true;
                divyespos.Visible = false;
                lblName_of_Award.Text = sdr["Awards"].ToString();
                lblName_of_awardee.Text = sdr["Name"].ToString();
                ...
                //lblName_of_awardee.Visible = false;
            ...
            else
            {
                ...
                lblKinName1.Visible = true;
                lblName_of_awardee_kin1.Visible = true;
                lblDOAKin0.Visible = true;
                lbldobnok1.Visible = true;
                lbl_award.Text= sdr["Awards"].ToString();
                lblName_of_awardee_kin1.Text = sdr["Name"].ToString();
                lblKinName1.Text= sdr["Name_of_NOK"].ToString();
                lblName_of_awardee_kin1.Text= sdr["Name"].ToString();
                lbldobnok1.Text = Convert.ToDateTime(sdr["Dob_NOK"]).ToString("dd-MM-yyyy");
                lblDOAKin0.Text= Convert.ToDateTime(sdr["Date_of_Award"]).ToString("dd-MM-yyyy");
                image2.ImageUrl = sdr["Document_1"].ToString();


                // lblName_of_awardee.Visible = true;
